...
Your entire response must be exactly the commit message and nothing else. The very first characters of your response must be the commit type (or `[prefix]` if applicable). Do not explain your reasoning, describe the changes, or add any text before or after the message — no explanation, no code fences, no labels. Also do not include co-authered section in the commit message.
